...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Menuju Indonesia style.css">
...
<body>
          ...
          <div class="container-login">
              <div class="main-box login">
                  ...
                  <form action="">
                      ...
                      <button type="submit" class="main-btn-login">Masuk</button>
                      <div class="register">
  ...
  <div class="center-text2">
      ...
      <p class="intro">
        Sebelum memulai petualangan mengagumkan di berbagai keindahan Indonesia, pastikan Anda telah mempersiapkan semua dokumen perjalanan yang diperlukan. Penting untuk memahami secara menyeluruh semua informasi terkait kebijakan imigrasi dan visa Indonesia yang berlaku bagi warga negara asal Anda. Hal ini akan membantu Anda menghindari segala ketidaknyamanan yang mungkin terjadi selama perjalanan. 
        Untuk informasi lebih lengkap tentang prosedur masuk ke Indonesia serta detail lainnya, silakan kunjungi halaman informasi Visa dan Imigrasi kami.
      </p>
